...
st.markdown(
    ...
    /* Main Text Elements (Headers, Paragraphs, Labels) */
    ...
    /* Fix: Target Inputs specifically, but NOT generic divs/spans */
    ...
    /* Fix: Expander Headers (The "List Buttons") */
    ...
    /* Ensure svg icons in expanders match text color */
    ...
    /* Fix: Selectbox/Dropdown Menu Items */

    /* This ensures dropdown options are visible regardless of theme */

    ul[data-testid="stSelectboxVirtualDropdown"] li {{

        color: black !important; /* Force black text in dropdowns for readability */
